...
from forms import ANCNotifyForm
...
class AncInfoTemplateView(TemplateView):
    ...
    def get_context_data(self, *args, **kwargs):
        context = super(AncInfoTemplateView, self).get_context_data(*args, **kwargs)
        anc = self.kwargs['anc'].upper()
        try:
        ...
        context['anc'] = anc
        context['info'] = info
        context['documents'] = recent_documents
        context['highlight_documents'] = highlight_documents
        context['census_stats'] = census_stats
        context['next_meeting'] = next_meeting
        context['form'] = ANCNotifyForm
